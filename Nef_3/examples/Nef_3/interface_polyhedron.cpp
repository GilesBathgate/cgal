...
void exportAsciiSTL(Polyhedron poly)
{
        ...
        for(FacetIterator fi=poly.facets_begin(); fi!=poly.facets_end(); ++fi) {
                ...
                float x2=CGAL::to_double(t[1].x());
                float y2=CGAL::to_double(t[1].y());
                float z2=CGAL::to_double(t[1].z());
                float x3=CGAL::to_double(t[2].x());
                float y3=CGAL::to_double(t[2].y());
                float z3=CGAL::to_double(t[2].z());
